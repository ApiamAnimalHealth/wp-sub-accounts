 ...
 */
class Wp_Sub_Accounts_Multi_Role_Model {
    ...
    public function get_roles() {
        ...
        return apply_filters( 'wp_sub_account_get_roles', $wp_roles->role_names );
    }
    ...
    public function get_user_roles( $user = 0 ) {
        ...
        return apply_filters( 'wp_sub_account_get_user_roles', $roles );
